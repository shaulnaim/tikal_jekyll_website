...
module Jekyll
  module Filters
    ...
    #
    # If baseurl is set to '/' the method returns an empty string, thus
    # ensuring that a legal url will be generated even when baseurl
    # has not been set in _config.yml.
    def get_baseurl
